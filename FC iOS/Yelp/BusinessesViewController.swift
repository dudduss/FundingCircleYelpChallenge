...
//        var k:YelpSortMode? = .Distance
    ...
    func postOne(var index: Int) {
        
        if (index == businesses.count) {
            return
        }
        
        let urlString = "http://localhost:3000/api/business/addBusiness"
        
        let business = businesses[index]
//        business.
        
        let categoriesString = business.categories
        let arr = categoriesString!.componentsSeparatedByString(", ")
        
        
        var bodyData = "yelpID=" + business.id! + "&name=" + business.name! + "&address=" + business.address!
        bodyData += "&description=" + business.businessDescription! + "&imageURL=" + (business.imageURL?.absoluteString)!
        
        if (arr.count == 3) {
            bodyData += "&primaryCategory=" + arr[0] + "&secondaryCategory=" + arr[1] + "&tertiaryCategory=" + arr[2]
        } else if (arr.count == 2) {
            bodyData += "&primaryCategory=" + arr[0] + "&secondaryCategory=" + arr[1]
        } else {
            bodyData += "&primaryCategory=" + arr[0]
        }
        
        bodyData += "&lat=" + String(business.latitude) + "&lon=" + String(business.longitude)
...
//            print(data: data!, encoding: NSUTF8StringEncoding)
//        }
