...
class Business: NSObject {
    ...
    init(dictionary: NSDictionary) {
        ...
        businessDescription = dictionary["snippet_text"] as? String
        latitude = dictionary["location"]!["coordinate"]!!["latitude"] as? Float
        longitude = dictionary["location"]!["coordinate"]!!["longitude"] as? Float
